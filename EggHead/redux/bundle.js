...
/***/ function(module, exports, __webpack_require__) {
	...
	var _add_todo = __webpack_require__(179);
	...
	var _visible_todo_list = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	AddTodo = (0, _reactRedux.connect)(null, null)(AddTodo);
...
/***/ function(module, exports) {
	...
	var toggleTodos = exports.toggleTodos = function toggleTodos(id) {
		return {
			type: 'TOGGLE_TODO',
			id: id
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filter_link = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onClick: function onClick() {
	      return dispatch((0, _index.setVisibilityFilter)(ownProps.filter));
	    }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todo_list = __webpack_require__(185);
	...
	var getVisibiltyTodos = function getVisibiltyTodos(todos, filter) {
		switch (filter) {
			case 'SHOW_ALL':
				return todos;
			case 'SHOW_COMPLETED':
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			onTodoClick: function onTodoClick(id) {
				dispatch((0, _index.toggleToDos)(id));
			}
		};
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.testToggleTodo = exports.testAddTodo = exports.store = undefined;

	var _expect = __webpack_require__(188);

	var _expect2 = _interopRequireDefault(_expect);

	var _deepFreeze = __webpack_require__(209);
	...
	var store = exports.store = (0, _redux.createStore)(todoApp);
	...
	var testAddTodo = exports.testAddTodo = function testAddTodo() {
		var stateBefore = [];
		var action = {
			type: 'ADD_TODO',
			id: 0,
		...
		(0, _expect2.default)((0, _index.todos)(stateBefore, action)).toEqual(stateAfter);
	...
	var testToggleTodo = exports.testToggleTodo = function testToggleTodo() {
		...
		store.dispatch(_extends({}, stateBefore[0], { type: 'ADD_TODO' }));
		console.log('Current state');
		console.log(store.getState());
		console.log('-------------');

		console.log('Dispatching ADD_TODO');
		store.dispatch(_extends({}, stateBefore[1], { type: 'ADD_TODO' }));
		console.log('Current state');
		console.log(store.getState());
		console.log('-------------');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expectation = __webpack_require__(189);

	var _Expectation2 = _interopRequireDefault(_Expectation);

	var _SpyUtils = __webpack_require__(206);

	var _assert = __webpack_require__(204);

	var _assert2 = _interopRequireDefault(_assert);

	var _extend = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isEqual = __webpack_require__(190);

	var _isEqual2 = _interopRequireDefault(_isEqual);

	var _isRegex = __webpack_require__(199);
	...
	var _TestUtils = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrowFunction = __webpack_require__(193);
	var isBoolean = __webpack_require__(195);
	var isDate = __webpack_require__(196);
	var isGenerator = __webpack_require__(197);
	var isNumber = __webpack_require__(198);
	var isRegex = __webpack_require__(199);
	var isString = __webpack_require__(200);
	...
	var symbolIterator = __webpack_require__(202)();

	var collectionsForEach = __webpack_require__(203)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectInspect = __webpack_require__(205);
