/*! For license information please see 2.85773bea.chunk.js.LICENSE.txt */
  ...
  [
    ...
    function (e, t, n) {
      ...
      function s(e, t, n, r) {
        ...
        return (
          ...
          r
            ? a.pathname
              ? "/" !== a.pathname.charAt(0) &&
                (a.pathname = Object(i.a)(a.pathname, r.pathname))
      ...
      function p(e) {
        ...
        var y = d(i, 0, a.length - 1),
          g = a.map(function (e) {
            return s(e, void 0, "string" === typeof e ? v() : e.key || v());
          }),
          b = c;
        function w(e) {
          var t = d(k.index + e, 0, k.entries.length - 1),
            r = k.entries[t];
        ...
        var k = {
          ...
          push: function (e, t) {
            var r = "PUSH",
              a = s(e, t, v(), k.location);
            h.confirmTransitionTo(a, r, n, function (e) {
              if (e) {
                var t = k.index + 1,
                  n = k.entries.slice(0);
    ...
    function (e, t, n) {
      ...
      function m(e, t, n, r) {
        ...
        "string" === typeof e
          ...
          : (void 0 === (a = Object(i.a)({}, e)).pathname && (a.pathname = ""),
            a.search
              ? "?" !== a.search.charAt(0) && (a.search = "?" + a.search)
              : (a.search = ""),
            a.hash
        ...
        return (
          ...
          r
            ? a.pathname
              ? "/" !== a.pathname.charAt(0) &&
                (a.pathname = Object(u.a)(a.pathname, r.pathname))
              : (a.pathname = r.pathname)
            : a.pathname || (a.pathname = "/"),
          a
        );
      ...
      function O(e) {
        ...
        function D(e) {
          1 === (F += e) && 1 === e
            ...
            : 0 === F && window.removeEventListener(S, L);
        }
        var A = !1;
        var U = {
          length: t.length,
              ...
              if (e) {
                ...
                if (C() !== a) {
                  ...
                  var o = j.lastIndexOf(h(U.location)),
                    l = j.slice(0, o + 1);
                  l.push(t), (j = l), O({ action: n, location: r });
                } else O();
              }
            });
          },
          replace: function (e, t) {
            ...
            E.confirmTransitionTo(r, n, a, function (e) {
              if (e) {
                ...
                -1 !== o && (j[o] = t), O({ action: n, location: r });
              }
            });
          },
          go: I,
      ...
      var j = M(function (e, t) {
        var n = e.innerRef,
          r = e.navigate,
          a = e.onClick,
          o = Object(T.a)(e, ["innerRef", "navigate", "onClick"]),
          u = o.target,
          c = Object(i.a)({}, o, {
            onClick: function (e) {
              try {
        ...
        return (c.ref = (z !== M && t) || n), l.a.createElement("a", c);
      });
      var I = M(function (e, t) {
          var n = e.component,
            a = void 0 === n ? j : n,
            o = e.replace,
            u = e.to,
          ...
          return l.a.createElement(r.c.Consumer, null, function (e) {
            e || Object(c.a)(!1);
            var n = e.history,
              r = R(L(u, e.location), e.location),
              d = r ? n.createHref(r) : "",
              p = Object(i.a)({}, f, {
                href: d,
                navigate: function () {
                  var t = L(u, e.location);
                  (o ? n.replace : n.push)(t);
                },
              });
            return (
              z !== M ? (p.ref = t || s) : (p.innerRef = s),
              l.a.createElement(a, p)
            );
          });
        }),
        F = function (e) {
      ...
      D(function (e, t) {
        ...
        return l.a.createElement(r.c.Consumer, null, function (e) {
          ...
          return (
            F !== D ? (P.ref = t || b) : (P.innerRef = b),
            l.a.createElement(I, P)
          );
        });
      });
    },
    ...
    function (e, t, n) {
      ...
      t.a = function (e, t) {
        ...
        var n,
          ...
          c = i || u;
        if (
          (e && r(e) ? (l = o) : o.length && (l.pop(), (l = l.concat(o))),
          !l.length)
        )
          return "/";
        if (l.length) {
      ...
      function d(e) {
        ...
        function o(e, t) {
          return (
            void 0 === t && (t = null),
            l(
              Object(a.a)({}, b, {}, "string" === typeof e ? f(e) : e, {
                state: t,
                key: c(),
              })
            )
        ...
        return (
          null == g &&
            ((g = 0), m.replaceState(Object(a.a)({}, m.state, { idx: g }), "")),
          {
            get action() {
              return y;
            },
            ...
            block: function (e) {
              var t = k.push(e);
              return (
                1 === k.length && h.addEventListener("beforeunload", i),
                function () {
    ...
    function (e, t, n) {
      ...
      function oi(e) {
        switch (e.tag) {
          ...
          case 3:
            if ((Ro(), ia(fa), ia(sa), qo(), 0 !== (64 & (t = e.flags))))
              throw Error(l(285));
      ...
      function hu(e) {
        ...
        var n = Dt(e, e === Ni ? Ri : 0);
        if (0 === n) return null;
        var r = n,
          a = Ti;
        Ti |= 16;
        var o = Su();
        for ((Ni === e && Ri === r) || (Wi(), ku(e, r)); ; )
          try {
            Cu();
            break;
          } catch (u) {
      ...
      function Du(e, t, n) {
        ...
        null !== r && r.delete(t),
          ...
          Ni === e &&
            (Ri & n) === n &&
            (4 === ji || (3 === ji && (62914560 & Ri) === Ri && 500 > Ua() - Vi)
              ? ku(e, 0)
              : (Ui |= n)),
          pu(e, t);
      }
...
//# sourceMappingURL=2.85773bea.chunk.js.map
